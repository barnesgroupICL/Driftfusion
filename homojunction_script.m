...
%% Fig 1a. Equilibrium electric field
dfplot.Fx(soleq_hom.el)
hold on
dfplot.Fx(soleq_hom_Ncat1e17.ion)
hold on
dfplot.Fx(soleq_hom_Ncat1e18.ion)
hold on
dfplot.Fx(soleq_hom.ion)           % Nion = 1e19 cm-3
...
%% Fig 1b. Open circuit Electric field
dfplot.Fx(OC_hom_el)
hold on
...
%% Fig 1c. Steady state maximum power current density transients
...
%% Figure 1d. Current-density voltage scans 
% (forward scan indicated by -F, reverse scan indicated by -R)
