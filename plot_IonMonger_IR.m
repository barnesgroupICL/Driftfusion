...
n_im = [sol_im.dstrbns.nE, sol_im.dstrbns.n, nan(length(sol_im.time), size(sol_im.dstrbns.pH, 2))]*1e-6;
p_im = [nan(length(sol_im.time), size(sol_im.dstrbns.nE, 2)), sol_im.dstrbns.p, sol_im.dstrbns.pH]*1e-6;
c_im = [nan(length(sol_im.time), size(sol_im.dstrbns.nE, 2)),  sol_im.dstrbns.P, nan(length(sol_im.time), size(sol_im.dstrbns.pH, 2))]*1e-6;    
