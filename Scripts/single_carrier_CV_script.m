...
sol_CV_k10 = doCV(soleq_single_carrier.ion, 0, 0.6, -0.6, 10, 4, 401);
sol_CV_k100 = doCV(soleq_single_carrier.ion, 0, 0.6, -0.6, 100, 4, 401);

%% Plot CV using currents from left-hand boundary (x=0)
dfplot.JVapp(sol_CV_k1, 0);
hold on
dfplot.JVapp(sol_CV_k10, 0);
hold on
dfplot.JVapp(sol_CV_k100, 0);