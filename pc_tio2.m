classdef pc_tio2
    ...
    % pc_tio2 (Parameters Class) defines all the required properties for your
    % device. pc_tio2.BUILDDEV builds a structure pc_tio2.DEV that defines the
    ...
    % be rebuilt using pc_tio2.BUILDDEV. The spatial mesh is a linear piece-wise mesh and is built by the
    ...
    properties
        ...
        dcell = {{150e-7, 50e-7}; {30e-7, 450e-7, 30e-7}; {50e-7}};       % Layer and subsection thickness array
        pcell = {{75, 50}; {30, 225, 30}; {50}};                         % Number of points in layers and subsections array        
        ...
        stack = {'Spiro', 'MAPICl', 'TiO2'}
        
        %% Energy levels [eV] 
        EA = [-2.8, -3.8, -4.1];          % Electron affinity
        IP = [-4.9, -5.4, -6.4];          % Ionisation potential  
        
        %% Equilibrium Fermi energies [eV]
        % E0 defines the doping density in each layer- see NA and ND calculations in methods         
        E0 = [-4.75, -4.6, -4.25];
        ...
        mue = [0.02, 20, 0.09];         % electron mobility 
        muh = [0.02, 20, 0.09];         % hole mobility
    ...
    methods
        ...
        function par = pc_tio2
            ...
            par.dev  = pc_tio2.builddev(par);
            % Build initial xmesh
            par.xx = pc_tio2.xmeshini(par);
        end
