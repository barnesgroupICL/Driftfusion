...
%
% Example:
%   ISwave_full_exec(genIntStructs(ssol_i_eq, 100, 1e-7, 4), 1e9, 1e-2, 23, 1e-3, false, true)
...
%     0.01 Hz
%   ISwave_full_exec(genIntStructs(ssol_i_eq, 100, 1e-7, 4), 1e9, 1e-2, 23, 1e-3, true, true)
