...
% soleq_toy_ptype_0off2 = equilibrate(par.toy.ptype_0off2);
% soleq_toy_ntype_0off2 = equilibrate(par.toy.ntype_0off2);
% 
% % 
...
% JV_toy_ptype_0off2.JV500mVs = doJV(soleq_toy_ptype_0off2.i_sr, 500e-3, 100, 1, 1, 0, 1.4, 2);
% JV_toy_ntype_0off2.JV500mVs = doJV(soleq_toy_ntype_0off2.i_sr, 500e-3, 100, 1, 1, 0, 1.4, 2);
